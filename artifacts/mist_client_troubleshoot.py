...
def build_demo() -> dict[str, Any]:
    ...
    events = [
        ...
        pick_event({"timestamp": t - 3600, "type": "CLIENT_DISASSOCIATION", "text": "STA leaving BSS", "ap": "0a0027aa1103", "ssid": "CORP-WIFI", "band": "5", "channel": 36, "reason": 8}),
    ]
    sessions = [
        {"ap": "0a0027aa1102", "ssid": "CORP-WIFI", "band": "5", "connect": t - 214, "disconnect": None, "duration": 214.0},
        {"ap": "0a0027aa1103", "ssid": "CORP-WIFI", "band": "5", "connect": t - 480, "disconnect": t - 148, "duration": 28.0},
        {"ap": "0a0027aa1103", "ssid": "CORP-WIFI", "band": "5", "connect": t - 900, "disconnect": t - 840, "duration": 44.0},
        {"ap": "0a0027aa1102", "ssid": "CORP-WIFI", "band": "5", "connect": t - 7200, "disconnect": t - 3600, "duration": 3580.0},
    ]
    marvis = {
